                                        ...
                                        <tr key={entry.id} onClick={() => handleView(entry)} style={{ cursor: 'pointer', transition: 'background 0.2s' }} className="hover-row">
                                            ...
                                            <td onClick={(e) => e.stopPropagation()}>
                                                <div style={{ display: 'flex', gap: '8px' }}>
                                                    ...
                                                    <button onClick={() => handleView(entry)} className="btn-icon btn-view" title={t.details}>
                                                        <i className="fas fa-eye"></i>
                                                    </button>

                                                    {(canEdit(entry)) && (
                                                        <div style={{ display: 'flex', gap: '8px' }}>
                                                            <button onClick={() => handleEdit(entry)} className="btn-icon btn-edit" title={t.edit}>
                                                                <i className="fas fa-edit"></i>
                                                            </button>
                                                            <button onClick={() => handleDelete(entry.id)} className="btn-icon btn-delete" title={t.delete}>
