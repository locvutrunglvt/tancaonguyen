                                    ...
                                    <tr key={training.id} onClick={() => handleView(training)} style={{ cursor: 'pointer', transition: 'background 0.2s' }} className="hover-row">
                                        ...
                                        <td onClick={(e) => e.stopPropagation()}>
                                            <div style={{ display: 'flex', gap: '8px' }}>
                                                ...
                                                {canEdit() && (
                                                    <div style={{ display: 'flex', gap: '8px' }}>
                                                        <button onClick={() => handleEdit(training)} className="btn-primary" style={{ background: '#fef3c7', color: '#92400e', border: '1px solid #fcd34d' }} title={t.edit}>
                                                            <i className="fas fa-edit"></i>
                                                        </button>
                                                        <button onClick={() => handleDelete(training.id)} className="btn-primary" style={{ background: '#fee2e2', color: '#b91c1c', border: '1px solid #fecaca' }} title={t.delete}>
